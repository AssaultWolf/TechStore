...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Productrates.findAll", query = "SELECT p FROM Productrates p"),
    @NamedQuery(name = "Productrates.findById", query = "SELECT p FROM Productrates p WHERE p.id = :id"),
    @NamedQuery(name = "Productrates.findByRating", query = "SELECT p FROM Productrates p WHERE p.rating = :rating")})
